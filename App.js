...
const AddLogo = props => {
    return (
        /* jshint ignore:start */
        <a href="#">
            <img src="images/logo.svg" className={props.name}/>
        </a>
        /* jshint ignore:end */
    );    
};
                ...
                <div className="features-wrapper">
                    ...
                    <div className="features-slider">
                        <div className="features-slider_items">
                            <SliderItem Url={"images/1.svg"}/>
                            <SliderItem Url={"images/2.svg"}/>
                            <SliderItem Url={"images/3.svg"}/>
                            <SliderItem Url={"images/4.svg"}/>                            
                        </div>
